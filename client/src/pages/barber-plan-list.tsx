    ...
    <div className="w-full p-6">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="bg-slate-50 p-2 rounded">
                  <div className="text-xs text-slate-500"><TranslatableText>1 Month</TranslatableText></div>
                  <div className="font-semibold text-sm">{plan.price1m ? `$${plan.price1m}` : 'N/A'}</div>
                </div>
                <div className="bg-slate-50 p-2 rounded">
                  <div className="text-xs text-slate-500"><TranslatableText>3 Months</TranslatableText></div>
                  <div className="font-semibold text-sm">{plan.price3m ? `$${plan.price3m}` : 'N/A'}</div>
                </div>
                <div className="bg-slate-50 p-2 rounded">
                  <div className="text-xs text-slate-500"><TranslatableText>12 Months</TranslatableText></div>
              ...
              <div className="flex gap-2">
                ...
                >
                  ...
                  <TranslatableText>Pay</TranslatableText>
                </Button>
                <Button
                  variant="outline"
                  size="sm"
      ...
      {filteredPlans.length === 0 && !isLoading && (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2"><TranslatableText>No plans found</TranslatableText></h3>
          ...
          >
            <Plus className="w-4 h-4 mr-2" />
            <TranslatableText>Create New Plan</TranslatableText>
          </Button>
        </div>
      )}
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle><TranslatableText>Delete Barber Plan</TranslatableText></AlertDialogTitle>
            <AlertDialogDescription>
              <TranslatableText>Are you sure you want to delete this barber plan? This action cannot be undone.</TranslatableText>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>
